...
void CodeGenerator::visitMethodCallNode(MethodCallNode* node) {
    ...
    if (node->identifier_2) {
        ...
        std::cout << getIndent(TAB_COUNTER) << "push " << findVariableOffset(this, findVariableObjectName(this, this->currentClassName, node->identifier_1->name), node->identifier_1->name) << "(%ebp)" << "                        # push the receiver object self pointer." << std::endl;
