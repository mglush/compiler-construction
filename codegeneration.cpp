...
void CodeGenerator::visitDivideNode(DivideNode* node) {
    ...
    std::cout << getIndent(TAB_COUNTER) << "mov %eax, %ebx" << "                                # sign extend %eax (the dividend) into %edx." << std::endl;
    std::cout << getIndent(TAB_COUNTER) << "pop %eax" << "                           # pop the divisor." << std::endl;
